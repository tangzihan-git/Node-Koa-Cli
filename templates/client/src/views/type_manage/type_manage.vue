    ...
    <div>
        ...
        <div class="container">
            <div class="handle-box">
                <el-button type="danger" icon="el-icon-delete" class="handle-del mr10" @click="delAllSelection('type')">批量删除</el-button>
                ...
                <el-table-column label="操作" width="180" align="center">
                    <template slot-scope="scope">
                        ...
                        <el-button
                            ...
                            icon="el-icon-delete"
                            class="red"
                            @click="handleDelete(scope.$index, scope.row,'type')"
                        >删除</el-button>
                    </template>
                </el-table-column>
            </el-table>
            <div class="pagination">
                <el-pagination
                    ...
                    :total="pageTotal"
                    @current-change="handlePageChange($event,'type')"
                ></el-pagination>
            </div>
        </div>
        <!-- 编辑&添加弹框 -->
    ...
    methods: {
        ...
        submit(){
            if(this.title=='添加'){
                ...
                this.postJSON('/type',this.form).then(res=>{
                ...
                this.putJSON('type/'+this.form._id,this.form).then(res=>{
